...
/**
* This class acts as the console user interface with the simulation.
* @author SteveWoerpel
*/
import java.util.*;
...
public class ConsoleSimulator 
{
   ...
   /**
   * This method continuously polls the user for commands and acts on those
   * commands until the quit command is issued.
   */
   public void run()
   {
   ...
   /**
   * This method adds a new customer to the simulation and outputs messages
   * associated with the arrival of a new customer.
   */
   ...
   /**
   * This method removes a customer from the simulation.  This is equivalent
   * to a customer completing the processes of being served.
   */
   ...
   /**
   * This method increases the current time of the simulation by one second.
   */
   ...
   /**
    * This method prints statics about the current state of the simulation.
    */
